...
throughout the file. Each line of the code blocks in this report is clickable and links
to the corresponding source line in the GitHub v1.0.0 tag.
\subsection{Group Action}
I first declare a minimal class for group actions:
\begin{leancodegit}[firstnumber=20]{lean/GroupAction/Defs.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Defs.lean}
...
Next, I define the faithful and transitive predicates for actions:
\begin{leancodegit}[firstnumber=26]{lean/GroupAction/Defs.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Defs.lean}
...
\begin{leancodegit}[firstnumber=13]{lean/GroupAction/Basic.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Basic.lean}
...
\begin{leancodegit}[firstnumber=19]{lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Examples.lean}
...
\begin{leancodegit}[firstnumber=28]{lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Examples.lean}
...
\begin{leancodegit}[firstnumber=44]{lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Examples.lean}
...
\begin{leancodegit}[firstnumber=55]{lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Examples.lean}
...
\begin{leancodegit}[firstnumber=66]{lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Examples.lean}
...
\begin{leancodegit}[firstnumber=88]{lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Examples.lean}
...
\begin{leancodegit}[firstnumber=103]{lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Examples.lean}
...
\begin{leancodegit}[firstnumber=134]{lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Examples.lean}
...
\begin{leancodegit}[firstnumber=26]{lean/GroupAction/Permutation.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Permutation.lean}
...
\begin{leancodegit}[firstnumber=33]{lean/GroupAction/Permutation.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Permutation.lean}
...
\begin{leancodegit}[firstnumber=64]{lean/GroupAction/Permutation.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Permutation.lean}
  #check sigmaPerm
\end{leancodegit}
...
\begin{leancodegit}[firstnumber=66]{lean/GroupAction/Permutation.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Permutation.lean}
...
\begin{leancodegit}[firstnumber=101]{lean/GroupAction/Permutation.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Permutation.lean}
...
\begin{leancodegit}[firstnumber=22]{lean/GroupAction/Stabilizer.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Stabilizer.lean}
  /-- The stabilizer set
  `G_x = { g ∈ G | g • x = x }`. -/
...
\end{itemize}
\begin{leancodegit}[firstnumber=27]{lean/GroupAction/Stabilizer.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Stabilizer.lean}
...
\begin{leancodegit}[firstnumber=54]{lean/GroupAction/Stabilizer.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.0.0/lean/GroupAction/Stabilizer.lean}
