...
\leancodefile[firstline=44,lastline=51,firstnumber=44]{../lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.2.0/lean/GroupAction/Examples.lean}
...
\leancodefile[firstline=55,lastline=64,firstnumber=55]{../lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.2.0/lean/GroupAction/Examples.lean}
...
\leancodefile[firstline=66,lastline=84,firstnumber=66]{../lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.2.0/lean/GroupAction/Examples.lean}
...
\leancodefile[firstline=88,lastline=98,firstnumber=88]{../lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.2.0/lean/GroupAction/Examples.lean}
...
\leancodefile[firstline=139,lastline=155,firstnumber=139]{../lean/GroupAction/Examples.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.2.0/lean/GroupAction/Examples.lean}
...
\leancodefile[firstline=31,lastline=63,firstnumber=31]{../lean/GroupAction/Permutation.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.2.0/lean/GroupAction/Permutation.lean}
...
\leancodefile[firstline=69,lastline=73,firstnumber=69]{../lean/GroupAction/Permutation.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.2.0/lean/GroupAction/Permutation.lean}
...
\leancodefile[firstline=78,lastline=100,firstnumber=78]{../lean/GroupAction/Permutation.lean}{https://github.com/FrankieeW/GroupAction/blob/v1.2.0/lean/GroupAction/Permutation.lean}
...
% \begin{itemize}
% 	\item \textbf{File Structure}: Every file starts with a header block comment
% 	\item \textbf{Imports}: All imports at top of file, before any code
% 	\item \textbf{Sections}: Use \texttt{/-! ## Section Name -/} for major sections
% 	\item \textbf{Spacing}: Two-space indentation throughout
% 	\item \textbf{Naming}: Definitions/lemmas use \texttt{snake\_case} (e.g., \texttt{ga\_mul}, \texttt{phi\_mul})
% 	\item \textbf{Hypotheses}: Use \texttt{h} prefix (e.g., \texttt{hg₁}, \texttt{hx})
% 	\item \textbf{Proof Style}: Readable tactics (\texttt{intro}, \texttt{apply}, \texttt{simp}, \texttt{rw}, \texttt{calc})
% 	\item \textbf{Type Annotations}: Explicit types when clarity requires
% 	\item \textbf{Documentation}: Use \texttt{/-! Brief description -/} for definitions and theorems
% \end{itemize}
...
\begin{enumerate}
	\item \textbf{Write code} in appropriate module (\texttt{Defs.lean}, \texttt{Basic.lean}, etc.)
	\item \textbf{Add \#check} statements in \texttt{Examples.lean} for verification
	\item \textbf{Test} with \texttt{lake env lean <file>}
	\item \textbf{Build} full project with \texttt{lake build}
	\item \textbf{Document} changes following commit rules in \texttt{doc/COMMIT\_RULES.md}
\end{enumerate}
