...
The development is split across modules under \texttt{lean/GroupAction/} and collected by
\texttt{lean/GroupAction.lean}.
...
\verb|mul_assoc.{u_1} {G : Type u_1} [Semigroup G] (a b c : G) : a * b * c = a * (b * c)|
